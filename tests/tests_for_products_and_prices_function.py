...
class testloaddata(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.filename = '../chesterfield_25-08-2021_09-00-00.csv'
    ...
    def test_extracting_basket_value(self):
        ...
        expected_outcome = {"basket":"Regular Flavoured iced latte - Hazelnut - 2.75, Large Latte - 2.45"}
        actual_outcome= {}.append(all_4th_values[0])
